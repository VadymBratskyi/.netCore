...
namespace BankApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Bank<Account> bank = new Bank<Account>("OSHBБанк");
            bool alive = true;
            while (alive)
            {
        ...
        private static void OpenAccount(Bank<Account> bank)
        {
            ...
            bank.Open(accountType,
                ...
                ErrorAccountHandler); // обработчик ошибки счета
        }
        ...
        // обработчик ошибки счета
        private static void ErrorAccountHandler(object sender, AccountEventArgs e)
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine(e.Message);
            Console.ResetColor();
